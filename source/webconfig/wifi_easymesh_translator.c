...
webconfig_error_t translate_sta_object_to_easymesh_for_assocdev_stats(webconfig_subdoc_data_t *data)
{
    ...
    wifi_platform_property_t *wifi_prop;
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d:bharathi Entering translate_sta_object_to_easymesh_for_assocdev_stats\n", __func__, __LINE__);
    ...
    if (params->collect_stats.stats == NULL) {
        wifi_util_info_print(WIFI_WEBCONFIG,
            "%s:%d: bharathi no associated device stats to translate\n", __func__, __LINE__);
        return webconfig_error_translate_to_easymesh;
    }
    ...
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d:bharathi Exiting translate_sta_object_to_easymesh_for_assocdev_stats\n", __func__, __LINE__);
    return webconfig_error_none;
}
