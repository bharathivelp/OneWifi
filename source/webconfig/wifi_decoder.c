...
static webconfig_error_t decode_anqp_object_impl(const cJSON *anqp, wifi_interworking_t *interworking_info, cJSON *passPointStats, cJSON *statsList)
{
    ...
    wifi_util_dbg_print(WIFI_WEBCONFIG,"%s:%d: bharathi enter Decoding ANQP object\n", __func__, __LINE__);
    ...
    wifi_util_dbg_print(WIFI_WEBCONFIG,"%s:%d: bharathi exit Decoded ANQP object\n", __func__, __LINE__);
    return webconfig_error_none;
}
...
{
    const cJSON *param;
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi enter Decoding radio channel entry\n", __func__, __LINE__);
    ...
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi exit Decoded radio channel entry\n", __func__, __LINE__);
    return webconfig_error_none;
}
...
webconfig_error_t decode_radio_channel_radio_stats_object(wifi_provider_response_t **chan_stats, cJSON *json)
{
    ...
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi enter Decoding radio channel stats object\n", __func__, __LINE__);
    ...
    *chan_stats = (wifi_provider_response_t*) calloc(1, sizeof(wifi_provider_response_t));
    ...
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi exit Decoded radio channel stats object\n", __func__, __LINE__);
...
{
    const cJSON *param;
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi enter Decoding neighbor stats entry\n", __func__, __LINE__);
    ...
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi exit Decoded neighbor stats entry\n", __func__, __LINE__);
...
webconfig_error_t decode_radio_neighbor_stats_object(wifi_provider_response_t **chan_stats, cJSON *json)
{
    ...
    wifi_neighborScanMode_t scan_mode;
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi enter Decoding neighbor stats object\n", __func__, __LINE__);
    ...
    *chan_stats = (wifi_provider_response_t*) calloc(1, sizeof(wifi_provider_response_t));
    ...
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi exit Decoded neighbor stats object\n", __func__, __LINE__);
    return webconfig_error_none;
}
...
{
    const cJSON *param;
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi enter Decoding associated device stats entry\n", __func__, __LINE__);
    ...
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi exit Decoded associated device stats entry\n", __func__, __LINE__);
...
webconfig_error_t decode_assocdev_stats_object(wifi_provider_response_t **assoc_stats, cJSON *json)
{
    ...
    const cJSON *param;
    int size = 0;
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi enter Decoding associated device stats object\n", __func__, __LINE__);
    ...
    *assoc_stats = (wifi_provider_response_t *)calloc(1, sizeof(wifi_provider_response_t));
    ...
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi exit Decoded associated device stats object\n", __func__, __LINE__);
    return webconfig_error_none;
}
...
{
    const cJSON *param;
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi enter Decoding radio diagnostic stats entry\n", __func__, __LINE__);
    ...
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi exit Decoded radio diagnostic stats entry\n", __func__, __LINE__);
...
webconfig_error_t decode_radiodiag_stats_object(wifi_provider_response_t **diag_stats, cJSON *json)
{
    ...
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi enter Decoding radio diagnostic stats object\n", __func__, __LINE__);
    ...
    *diag_stats = (wifi_provider_response_t*) calloc(1, sizeof(wifi_provider_response_t));
    ...
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi exit Decoded radio diagnostic stats object\n", __func__, __LINE__);
    return webconfig_error_none;
}
...
webconfig_error_t decode_radio_temperature_stats_object(wifi_provider_response_t **temp_stats, cJSON *json)
{
    ...
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi enter Decoding radio temperature stats object\n", __func__, __LINE__);
    ...
    *temp_stats = (wifi_provider_response_t*) calloc(1, sizeof(wifi_provider_response_t));
    ...
    wifi_util_dbg_print(WIFI_WEBCONFIG, "%s:%d: bharathi exit Decoded radio temperature stats object\n", __func__, __LINE__);
    return webconfig_error_none;
}
